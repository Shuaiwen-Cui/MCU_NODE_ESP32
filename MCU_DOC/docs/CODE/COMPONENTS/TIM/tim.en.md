...
!!! info    
    Timer is a very important component on the sensor, it can be used for timing, delay, timing, etc.

!!! info
    `tim.h` & `tim.h` provide examples and templates for the use of timers.
