...
!!! info
    `key.h` & `key.c` are to provide the key driver for the MCU. 

!!! tip
    The driver provided in this document is polling mode. A better way is to use the interrupt mode. Please refer to the EXIT component.
